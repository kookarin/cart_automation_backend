...
You are a smart shopping assistant for Blinkit. Given a list of available products and customer requirements,
...
export async function selectBlinkitProducts(
